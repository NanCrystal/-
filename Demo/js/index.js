...
function init() {
    getPubKey(function () {
        ////////////////////////////////// 请自行修改以下变量值	////////////////////////////////////		
        var appkey = "28034408";                           //综合安防管理平台提供的appkey，必填
        var secret = setEncrypt("xRQiQVtPW5o56FYtEt1z");   //综合安防管理平台提供的secret，必填
        var ip = "192.168.12.245";                           //综合安防管理平台IP地址，必填
    ...
    // initView(function () {
    //     var cameraIndexCode = 'c115f43709794f05b02b28cc2ada9e1e';     //获取输入的监控点编号值，必填
